...
DROP TABLE IF EXISTS type_publi ;
CREATE TABLE type_publi (code_type_publi INT NOT NULL,
libelle_type_publi VARCHAR(15),
PRIMARY KEY (code_type_publi) );
...
DROP TABLE IF EXISTS publiType ;
CREATE TABLE publiType (publinum INT  NOT NULL,
code_type_publi INT NOT NULL,
PRIMARY KEY (publinum,
 code_type_publi) );
