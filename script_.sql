...
CREATE TABLE Membres (persnum SERIAL NOT NULL,
persnom VARCHAR(50),
...
CREATE TABLE Equipes (equipnum SERIAL NOT NULL,
equipnom VARCHAR(50),
datecreation DATE,
PRIMARY KEY (equipnum));

DROP TABLE IF EXISTS Publications ;
CREATE TABLE Publications (publinum SERIAL NOT NULL,
titre VARCHAR(256),
publidate DATE,
...
CREATE TABLE Contrat (contnum SERIAL NOT NULL,
contdebut DATE,
montant BIGINT,
projnom VARCHAR(8),
PRIMARY KEY (contnum));
...
CREATE TABLE Organisme (codorg SERIAL NOT NULL,
nomorg VARCHAR(16),
adrorg VARCHAR(100),
qualif VARCHAR(16),
PRIMARY KEY (codorg));
...
CREATE TABLE Domaines (domainnum SERIAL NOT NULL,
désignation VARCHAR(50),
PRIMARY KEY (domainnum));

DROP TABLE IF EXISTS Contacts ;
CREATE TABLE Contacts (idcontact SERIAL NOT NULL,
...
CREATE TABLE Auteurs (persnum SERIAL NOT NULL,
...
CREATE TABLE Financement (contnum SERIAL NOT NULL,
codorg INT NOT NULL,
apport BIGINT,
PRIMARY KEY (contnum,
 codorg));
...
CREATE TABLE ParticipProj (persnum SERIAL NOT NULL,
...
CREATE TABLE Dev_Proj (equipnum SERIAL NOT NULL,
projnom VARCHAR(8) NOT NULL,
porteur BOOL,
PRIMARY KEY (equipnum,
 projnom));
...
CREATE TABLE ContraSuivi (contnum SERIAL NOT NULL,
